# backend/aes.py
# -----------------------------
# AES-128 block cipher implementation in pure Python
...
# Round constants for key expansion (each as a 4-byte word)
RCON = [
...
def key_expansion(key):
    # key: 16-byte list
    # returns list of 176 bytes (11 round keys × 16)
    expanded = list(key)
    i = 16
    rcon_iter = 0
    while i < 176:
